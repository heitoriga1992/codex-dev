    ...
    class MicrobitBoardSvg {
      ...
      buildDom() {
        ...
        this.pinGradients = this.pins.map((pin, i) => {
          ...
          this.pins[25].setAttribute("fill", "#695e3b");
          this.pins[26].setAttribute("fill", "#fefe45");
          this.pins[27].setAttribute("fill", "#363616");
          this.pins[25].style.transform = "translate(198px, 10.75px)  scale(0.2)";
          this.pins[26].style.transform = "translate(198px, 10.75px)  scale(0.2)";
          this.pins[27].style.transform = "translate(198px, 10.75px)  scale(0.2)";
          return lg;
        });
