...
(function (pxsim) {
  class DalBoard extends pxsim.CoreBoard {
    constructor() {
      ...
      this.builtinParts["edgeconnector"] = this.edgeConnectorState = new pxsim.EdgeConnectorState({
        pins: [
          100 /* MICROBIT_ID_IO_P0 */, 101 /* MICROBIT_ID_IO_P1 */, 102 /* MICROBIT_ID_IO_P2 */, 103 /* MICROBIT_ID_IO_P3 */,
          104 /* MICROBIT_ID_IO_P4 */, 105 /* MICROBIT_ID_IO_P5 */, 106 /* MICROBIT_ID_IO_P6 */, 107 /* MICROBIT_ID_IO_P7 */,
          108 /* MICROBIT_ID_IO_P8 */, 109 /* MICROBIT_ID_IO_P9 */, 110 /* MICROBIT_ID_IO_P10 */, 111 /* MICROBIT_ID_IO_P11 */,
          112 /* MICROBIT_ID_IO_P12 */, 113 /* MICROBIT_ID_IO_P13 */, 114 /* MICROBIT_ID_IO_P14 */, 115 /* MICROBIT_ID_IO_P15 */,
          116 /* MICROBIT_ID_IO_P16 */, 0, 0, 119 /* MICROBIT_ID_IO_P19 */, 120 /* MICROBIT_ID_IO_P20 */,
        ],
        servos: {
    ...
    initAsync(msg) {
      ...
      this.viewHost = new pxsim.visuals.BoardHost(
    ...
    neopixelState(pinId) {
      ...
      if (!state) state = this.lightState[pinId] = new pxsim.CommonNeoPixelState();
      return state;
    }
  ...
  function parsePinString(gpioPin) {
    if (gpioPin == "*") return board().edgeConnectorState.getPin(100 /* MICROBIT_ID_IO_P0 */);
...
(function (pxsim) {
  ...
  class Accelerometer {
    ...
    updateEnvironmentGlobals() {
      // update debugger
      if (this.isActive) {
        if (this.flags & AccelerometerFlag.X) this.runtime.environmentGlobals[pxsim.localization.lf("acceleration.x")] = this.sample.x;
        if (this.flags & AccelerometerFlag.Y) this.runtime.environmentGlobals[pxsim.localization.lf("acceleration.y")] = this.sample.y;
        if (this.flags & AccelerometerFlag.Z) this.runtime.environmentGlobals[pxsim.localization.lf("acceleration.z")] = this.sample.z;
        ...
        if (this.flags & AccelerometerFlag.Pitch) this.runtime.environmentGlobals[pxsim.localization.lf("acceleration.pitch")] = this.getPitch();
        if (this.flags & AccelerometerFlag.Roll) this.runtime.environmentGlobals[pxsim.localization.lf("acceleration.roll")] = this.getRoll();
      }
    }
    ...
    instantaneousPosture() {
      ...
      // has been shaken.
      if (
        (this.getX() < -400 /* MICROBIT_ACCELEROMETER_SHAKE_TOLERANCE */ && this.shake.x) ||
        (this.getX() > 400 /* MICROBIT_ACCELEROMETER_SHAKE_TOLERANCE */ && !this.shake.x)
      ) {
        shakeDetected = true;
      ...
      if (
        (this.getY() < -400 /* MICROBIT_ACCELEROMETER_SHAKE_TOLERANCE */ && this.shake.y) ||
        (this.getY() > 400 /* MICROBIT_ACCELEROMETER_SHAKE_TOLERANCE */ && !this.shake.y)
      ) {
        shakeDetected = true;
      ...
      if (
        (this.getZ() < -400 /* MICROBIT_ACCELEROMETER_SHAKE_TOLERANCE */ && this.shake.z) ||
        (this.getZ() > 400 /* MICROBIT_ACCELEROMETER_SHAKE_TOLERANCE */ && !this.shake.z)
      ) {
        shakeDetected = true;
      ...
      if (
        shakeDetected &&
        this.shake.count < 4 /* MICROBIT_ACCELEROMETER_SHAKE_COUNT_THRESHOLD */ &&
        ++this.shake.count == 4 /* MICROBIT_ACCELEROMETER_SHAKE_COUNT_THRESHOLD */
      )
        this.shake.shaken = 1;
      ...
      if (this.shake.shaken) return 11 /* MICROBIT_ACCELEROMETER_EVT_SHAKE */;
      let sq = (n) => n * n;
      if (force < sq(400 /* MICROBIT_ACCELEROMETER_FREEFALL_TOLERANCE */)) return 7 /* MICROBIT_ACCELEROMETER_EVT_FREEFALL */;
      if (force > sq(3072 /* MICROBIT_ACCELEROMETER_3G_TOLERANCE */)) return 8 /* MICROBIT_ACCELEROMETER_EVT_3G */;
      if (force > sq(6144 /* MICROBIT_ACCELEROMETER_6G_TOLERANCE */)) return 9 /* MICROBIT_ACCELEROMETER_EVT_6G */;
      if (force > sq(8192 /* MICROBIT_ACCELEROMETER_8G_TOLERANCE */)) return 10 /* MICROBIT_ACCELEROMETER_EVT_8G */;
      // Determine our posture.
      if (this.getX() < -1000 + 200 /* MICROBIT_ACCELEROMETER_TILT_TOLERANCE */) return 3 /* MICROBIT_ACCELEROMETER_EVT_TILT_LEFT */;
      if (this.getX() > 1000 - 200 /* MICROBIT_ACCELEROMETER_TILT_TOLERANCE */) return 4 /* MICROBIT_ACCELEROMETER_EVT_TILT_RIGHT */;
      if (this.getY() < -1000 + 200 /* MICROBIT_ACCELEROMETER_TILT_TOLERANCE */) return 2 /* MICROBIT_ACCELEROMETER_EVT_TILT_DOWN */;
      if (this.getY() > 1000 - 200 /* MICROBIT_ACCELEROMETER_TILT_TOLERANCE */) return 1 /* MICROBIT_ACCELEROMETER_EVT_TILT_UP */;
      if (this.getZ() < -1000 + 200 /* MICROBIT_ACCELEROMETER_TILT_TOLERANCE */) return 5 /* MICROBIT_ACCELEROMETER_EVT_FACE_UP */;
      if (this.getZ() > 1000 - 200 /* MICROBIT_ACCELEROMETER_TILT_TOLERANCE */) return 6 /* MICROBIT_ACCELEROMETER_EVT_FACE_DOWN */;
      return 0;
    }
    updateGesture() {
...
(function (pxsim) {
  ...
  (function (visuals) {
    function mkBtnSvg(xy) {
      ...
      const btnR = visuals.PIN_DIST * 0.8;
    ...
    class ButtonPairView {
      ...
      attachEvents() {
        ...
        pxsim.pointerEvents.down.forEach((evid) =>
          this.abBtn.addEventListener(evid, (ev) => {
            updateBtns(true);
          })
        );
...
(function (pxsim) {
  ...
  (function (files) {
    ...
    function readToSerial(filename) {
      ...
      if (f) b.serialState.writeSerial(f);
    }
...
(function (pxsim) {
  ...
  (function (flashlog) {
    ...
    function beginRow() {
      init();
      if (currentRow) return -1015 /* DEVICE_INVALID_STATE */;
      currentRow = [];
      return 0 /* DEVICE_OK */;
    }
    ...
    function endRow() {
      init();
      if (!currentRow) return -1015 /* DEVICE_INVALID_STATE */;
      if (!currentRow.some((el) => el !== "" && el != undefined)) return 0 /* DEVICE_OK */;
...
(function (pxsim) {
  ...
  class Image extends pxsim.RefObject {
    ...
    shiftLeft(cols) {
      cols = cols | 0;
      for (let x = 0; x < this.width; ++x) for (let y = 0; y < this.height; ++y) this.set(x, y, x < this.width - cols ? this.get(x + cols, y) : 0);
    }
    shiftRight(cols) {
      cols = cols >> 0;
      for (let x = this.width - 1; x >= 0; --x) for (let y = 0; y < this.height; ++y) this.set(x, y, x >= cols ? this.get(x - cols, y) : 0);
    }
    clear() {
  ...
  pxsim.FONT_DATA = [
    0x0, 0x0, 0x0, 0x0, 0x0, 0x8, 0x8, 0x8, 0x0, 0x8, 0xa, 0x4a, 0x40, 0x0, 0x0, 0xa, 0x5f, 0xea, 0x5f, 0xea, 0xe, 0xd9, 0x2e, 0xd3, 0x6e, 0x19, 0x32,
    0x44, 0x89, 0x33, 0xc, 0x92, 0x4c, 0x92, 0x4d, 0x8, 0x8, 0x0, 0x0, 0x0, 0x4, 0x88, 0x8, 0x8, 0x4, 0x8, 0x4, 0x84, 0x84, 0x88, 0x0, 0xa, 0x44,
    0x8a, 0x40, 0x0, 0x4, 0x8e, 0xc4, 0x80, 0x0, 0x0, 0x0, 0x4, 0x88, 0x0, 0x0, 0xe, 0xc0, 0x0, 0x0, 0x0, 0x0, 0x8, 0x0, 0x1, 0x22, 0x44, 0x88, 0x10,
    0xc, 0x92, 0x52, 0x52, 0x4c, 0x4, 0x8c, 0x84, 0x84, 0x8e, 0x1c, 0x82, 0x4c, 0x90, 0x1e, 0x1e, 0xc2, 0x44, 0x92, 0x4c, 0x6, 0xca, 0x52, 0x5f, 0xe2,
    0x1f, 0xf0, 0x1e, 0xc1, 0x3e, 0x2, 0x44, 0x8e, 0xd1, 0x2e, 0x1f, 0xe2, 0x44, 0x88, 0x10, 0xe, 0xd1, 0x2e, 0xd1, 0x2e, 0xe, 0xd1, 0x2e, 0xc4, 0x88,
    0x0, 0x8, 0x0, 0x8, 0x0, 0x0, 0x4, 0x80, 0x4, 0x88, 0x2, 0x44, 0x88, 0x4, 0x82, 0x0, 0xe, 0xc0, 0xe, 0xc0, 0x8, 0x4, 0x82, 0x44, 0x88, 0xe, 0xd1,
    0x26, 0xc0, 0x4, 0xe, 0xd1, 0x35, 0xb3, 0x6c, 0xc, 0x92, 0x5e, 0xd2, 0x52, 0x1c, 0x92, 0x5c, 0x92, 0x5c, 0xe, 0xd0, 0x10, 0x10, 0xe, 0x1c, 0x92,
    0x52, 0x52, 0x5c, 0x1e, 0xd0, 0x1c, 0x90, 0x1e, 0x1e, 0xd0, 0x1c, 0x90, 0x10, 0xe, 0xd0, 0x13, 0x71, 0x2e, 0x12, 0x52, 0x5e, 0xd2, 0x52, 0x1c,
    0x88, 0x8, 0x8, 0x1c, 0x1f, 0xe2, 0x42, 0x52, 0x4c, 0x12, 0x54, 0x98, 0x14, 0x92, 0x10, 0x10, 0x10, 0x10, 0x1e, 0x11, 0x3b, 0x75, 0xb1, 0x31,
    0x11, 0x39, 0x35, 0xb3, 0x71, 0xc, 0x92, 0x52, 0x52, 0x4c, 0x1c, 0x92, 0x5c, 0x90, 0x10, 0xc, 0x92, 0x52, 0x4c, 0x86, 0x1c, 0x92, 0x5c, 0x92,
    0x51, 0xe, 0xd0, 0xc, 0x82, 0x5c, 0x1f, 0xe4, 0x84, 0x84, 0x84, 0x12, 0x52, 0x52, 0x52, 0x4c, 0x11, 0x31, 0x31, 0x2a, 0x44, 0x11, 0x31, 0x35,
    0xbb, 0x71, 0x12, 0x52, 0x4c, 0x92, 0x52, 0x11, 0x2a, 0x44, 0x84, 0x84, 0x1e, 0xc4, 0x88, 0x10, 0x1e, 0xe, 0xc8, 0x8, 0x8, 0xe, 0x10, 0x8, 0x4,
    0x82, 0x41, 0xe, 0xc2, 0x42, 0x42, 0x4e, 0x4, 0x8a, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1f, 0x8, 0x4, 0x80, 0x0, 0x0, 0x0, 0xe, 0xd2, 0x52,
    0x4f, 0x10, 0x10, 0x1c, 0x92, 0x5c, 0x0, 0xe, 0xd0, 0x10, 0xe, 0x2, 0x42, 0x4e, 0xd2, 0x4e, 0xc, 0x92, 0x5c, 0x90, 0xe, 0x6, 0xc8, 0x1c, 0x88,
    0x8, 0xe, 0xd2, 0x4e, 0xc2, 0x4c, 0x10, 0x10, 0x1c, 0x92, 0x52, 0x8, 0x0, 0x8, 0x8, 0x8, 0x2, 0x40, 0x2, 0x42, 0x4c, 0x10, 0x14, 0x98, 0x14, 0x92,
    0x8, 0x8, 0x8, 0x8, 0x6, 0x0, 0x1b, 0x75, 0xb1, 0x31, 0x0, 0x1c, 0x92, 0x52, 0x52, 0x0, 0xc, 0x92, 0x52, 0x4c, 0x0, 0x1c, 0x92, 0x5c, 0x90, 0x0,
    0xe, 0xd2, 0x4e, 0xc2, 0x0, 0xe, 0xd0, 0x10, 0x10, 0x0, 0x6, 0xc8, 0x4, 0x98, 0x8, 0x8, 0xe, 0xc8, 0x7, 0x0, 0x12, 0x52, 0x52, 0x4f, 0x0, 0x11,
    0x31, 0x2a, 0x44, 0x0, 0x11, 0x31, 0x35, 0xbb, 0x0, 0x12, 0x4c, 0x8c, 0x92, 0x0, 0x11, 0x2a, 0x44, 0x98, 0x0, 0x1e, 0xc4, 0x88, 0x1e, 0x6, 0xc4,
    0x8c, 0x84, 0x86, 0x8, 0x8, 0x8, 0x8, 0x8, 0x18, 0x8, 0xc, 0x88, 0x18, 0x0, 0x0, 0xc, 0x83, 0x60,
  ];
  function createFont() {
    ...
    for (let c = 0; c < n; c++) {
      for (let row = 0; row < 5; row++) {
        ...
        for (let col = 0; col < 5; col++) {
          if ((char & (1 << col)) != 0) font.set(c * 5 + 4 - col, row, 255);
        }
      }
    }
    return font;
...
(function (pxsim) {
  ...
  (function (fonts) {
    function charCodeBuffer(charCode) {
      if (charCode < 32 /* MICROBIT_FONT_ASCII_START */ || charCode > 126 /* MICROBIT_FONT_ASCII_END */) return undefined;
      const b = pxsim.board();
      ...
      for (let row = 0; row < h; ++row) buf.data[row] = pxsim.FONT_DATA[offset + row];
      return buf;
    }
...
(function (pxsim) {
  ...
  (function (basic) {
    function showNumber(x, interval) {
      ...
      if (x < 0 || x >= 10) pxsim.ImageMethods.scrollImage(leds, 1, interval);
...
(function (pxsim) {
  ...
  (function (led) {
    ...
    function plotBrightness(x, y, brightness) {
      ...
      if (brightness != 0 && brightness != 0xff && state.displayMode != pxsim.DisplayMode.greyscale) state.displayMode = pxsim.DisplayMode.greyscale;
...
(function (pxsim) {
  ...
  (function (pins) {
    function touchSetMode(name, mode) {
      const b = pxsim.board();
      if (b) b.ensureHardwareVersion(2);
      // not simulated
    }
...
(function (pxsim) {
  ...
  (function (input) {
    ...
    function setSoundThreshold(sound, threshold) {
      const b = pxsim.microphoneState();
      if (!b) return;
      if (sound === 2 /* SoundThreshold.Loud */) b.setHighThreshold(threshold);
      else b.setLowThreshold(threshold);
    }
  ...
  (function (visuals) {
    ...
    class MicroServoView {
      ...
      updateState() {
        ...
        if (this.targetAngle != this.currentAngle) this.renderAngle();
      }
      renderAngle() {
        const now = pxsim.U.now();
        const cx = 56.661;
        ...
        this.crankEl.setAttribute("transform", this.crankTransform + ` rotate(${this.currentAngle}, ${cx}, ${cy})`);
...
(function (pxsim) {
  ...
  (function (music) {
    ...
    (function (MusicalIntervals) {
      ...
      // #endif
      MusicalIntervals.chromaticInterval = [1.0, 1.0417, 1.125, 1.2, 1.25, 1.3333, 1.4063, 1.5, 1.6, 1.6667, 1.8, 1.875];
      MusicalIntervals.majorScaleInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[2],
        MusicalIntervals.chromaticInterval[4],
        MusicalIntervals.chromaticInterval[5],
        MusicalIntervals.chromaticInterval[7],
        MusicalIntervals.chromaticInterval[9],
        MusicalIntervals.chromaticInterval[11],
      ];
      MusicalIntervals.minorScaleInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[2],
        MusicalIntervals.chromaticInterval[3],
        MusicalIntervals.chromaticInterval[5],
        MusicalIntervals.chromaticInterval[7],
        MusicalIntervals.chromaticInterval[8],
        MusicalIntervals.chromaticInterval[10],
      ];
      MusicalIntervals.pentatonicScaleInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[2],
        MusicalIntervals.chromaticInterval[4],
        MusicalIntervals.chromaticInterval[7],
      ...
      MusicalIntervals.majorTriadInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[4],
        MusicalIntervals.chromaticInterval[7],
      ];
      MusicalIntervals.minorTriadInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[3],
        MusicalIntervals.chromaticInterval[7],
      ];
      MusicalIntervals.diminishedInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[3],
        MusicalIntervals.chromaticInterval[6],
        MusicalIntervals.chromaticInterval[9],
      ];
      MusicalIntervals.wholeToneInterval = [
        MusicalIntervals.chromaticInterval[0],
        MusicalIntervals.chromaticInterval[2],
        MusicalIntervals.chromaticInterval[4],
        MusicalIntervals.chromaticInterval[6],
...
(function (pxsim) {
  ...
  (function (music) {
    ...
    function lookupBuiltIn(sound) {
      ...
      if (sound == happy) return happyData;
      if (sound == hello) return helloData;
      if (sound == mysterious) return mysteriousData;
      if (sound == sad) return sadData;
      if (sound == slide) return slideData;
      if (sound == soaring) return soaringData;
      if (sound == spring) return springData;
      if (sound == twinkle) return twinkleData;
      if (sound == yawn) return yawnData;
      return sound;
    }
  })((music = pxsim.music || (pxsim.music = {})));
})(pxsim || (pxsim = {}));
...
(function (pxsim) {
  ...
  (function (visuals) {
    function mkLedMatrixSvg(xy, rows, cols) {
      ...
      let ledRad = Math.round(visuals.PIN_DIST * 0.35);
...
.sim-light-level-button:focus {
    ...
    class MicrobitBoardSvg {
      constructor(props) {
        ...
        this.buildDom();
        if (props && props.wireframe) pxsim.U.addClass(this.element, "sim-wireframe");
      ...
      updateTheme() {
        ...
        if (this.shakeButton) pxsim.svg.fill(this.shakeButton, theme.virtualButtonUp);
      ...
      updateState() {
        ...
        this.updateGestures();
        this.updateRSSI();
        if (!this.props.runtime || this.props.runtime.dead) pxsim.U.addClass(this.element, "grayscale");
      ...
      updateGestures() {
        ...
        if (state.accelerometerState.useShake && !this.shakeButton) {
          ...
          pxsim.pointerEvents.down.forEach((evid) =>
            this.shakeButton.addEventListener(evid, (ev) => {
              let state = this.board;
      ...
      updatePin(pin, index) {
        ...
        if (v) pxsim.svg.setGradientValue(this.pinGradients[index], v);
      ...
      updateTemperature() {
        ...
        if (!this.thermometer) {
          ...
          if (this.props.runtime) this.props.runtime.environmentGlobals[pxsim.localization.lf("temperature")] = state.thermometerState.temperature;
          this.updateTheme();
      ...
      updateSoundLevel() {
        ...
        if (!this.soundLevel) {
          ...
          if (this.props.runtime) this.props.runtime.environmentGlobals[pxsim.localization.lf("sound level")] = state.microphoneState.getLevel();
          this.updateTheme();
          let pt = this.element.createSVGPoint();
          pxsim.svg.buttonEvents(
            this.soundLevel,
      ...
      updateHeading() {
        ...
        if (!this.headInitialized) {
          ...
          p.setAttribute(
            "d",
            "m269.9,50.134647l0,0l-39.5,0l0,0c-14.1,0.1 -24.6,10.7 -24.6,24.8c0,13.9 10.4,24.4 24.3,24.7l0,0l39.6,0c14.2,0 40.36034,-22.97069 40.36034,-24.85394c0,-1.88326 -26.06034,-24.54606 -40.16034,-24.64606m-0.2,39l0,0l-39.3,0c-7.7,-0.1 -14,-6.4 -14,-14.2c0,-7.8 6.4,-14.2 14.2,-14.2l39.1,0c7.8,0 14.2,6.4 14.2,14.2c0,7.9 -6.4,14.2 -14.2,14.2l0,0l0,0z"
          );
          this.updateTheme();
          let pt = this.element.createSVGPoint();
        ...
        if (txt != this.headText.textContent) {
          ...
          if (this.props.runtime) this.props.runtime.environmentGlobals[pxsim.localization.lf("heading")] = state.compassState.heading;
        }
      }
      flashSystemLed() {
        if (!this.systemLed) this.systemLed = pxsim.svg.child(this.g, "circle", { class: "sim-systemled", cx: 300, cy: 20, r: 5 });
        let now = Date.now();
      ...
      flashAntenna() {
        if (!this.antenna) {
          ...
          this.antenna = pxsim.svg.child(this.g, "polyline", {
            class: "sim-antenna",
            points: `${ax},${ayb} ${ax},${ayt} ${(ax += dax)},${ayt} ${ax},${ayb} ${(ax += dax)},${ayb} ${ax},${ayt} ${(ax +=
              dax)},${ayt} ${ax},${ayb} ${(ax += dax)},${ayb} ${ax},${ayt} ${(ax += dax)},${ayt}`,
          });
      ...
      updateLightLevel() {
        ...
        if (!this.lightLevelButton) {
          ...
          if (this.props.runtime) this.props.runtime.environmentGlobals[pxsim.localization.lf("lightLevel")] = state.lightSensorState.lightLevel;
          this.updateTheme();
        ...
        pxsim.svg.setGradientValue(
          this.lightLevelGradient,
          Math.min(100, Math.max(0, Math.floor((state.lightSensorState.lightLevel * 100) / 255))) + "%"
        );
      ...
      findParentElement() {
        let el = this.element;
        while (el.parentNode && el.parentNode.nodeName == "svg") el = el.parentNode;
        return el;
      }
      updateTilt() {
        const state = this.board;
        ...
        if (state.buttonPairState.usesButtonAB || this.v2Circle || this.soundLevel) {
      ...
      buildDom() {
        ...
        for (let i = 0; i < 3; ++i) pxsim.svg.child(merge, "feMergeNode", { in: "glow" });
        // outline
        // this.pkg = svg.path(this.g, "sim-board", "M485.1,49.13C485.1,22.02,463.08,0,435.97,0H49.13C22.02,0,0,22.02,0,49.13v707.02C0,784.13,22.02,806.15,49.13,806.15h435.84c17.11,0,49.13-22.02,49.13-49.13V49.13z M22.02,378.07c-4.16,0-7.39-3.39-7.39-7.39c0-4.16,3.39-7.39,7.39-7.39c4.16,0,7.39,3.39,7.39,7.39C29.41,374.68,26.18,378.07,22.02,378.07z M467.77,378.07c-4.16,0-7.39-3.39-7.39-7.39c0-4.19,3.39-7.39,7.39-7.39c4.16,0,7.39,3.39,7.39,7.39C475.16,374.68,471.93,378.07,467.77,378.07z");
        //svg.hydrate(this.pkg, { fill: "#111", transform: "translate(0, -100)" });
        // outline
        this.pkg = pxsim.svg.path(
          this.g,
          "sim-board",
          "M509.36,51.59C509.36,23.12,486.24,0,457.77,0H51.59C23.12,0,0,23.12,0,51.59v743.82C0,822.88,23.12,846,51.59,846h457.18c23.47,0,51.59-23.12,51.59-51.59V51.59z M23.12,397.47c-4.37,0-7.76-3.56-7.76-7.76c0-4.37,3.56-7.76,7.76-7.76c4.37,0,7.76,3.56,7.76,7.76C30.88,393.91,27.49,397.47,23.12,397.47z M491.24,397.47c-4.37,0-7.76-3.56-7.76-7.76c0-4.39,3.56-7.76,7.76-7.76c4.37,0,7.76,3.56,7.76,7.76C498.99,393.91,495.61,397.47,491.24,397.47z"
        );
        pxsim.svg.hydrate(this.pkg, { fill: "#111", transform: "translate(0, -100)" });
        // script background
        this.display = pxsim.svg.path(
          this.g,
          "sim-display",
          "M333.8,310.3H165.9c-8.3,0-15-6.7-15-15V127.5c0-8.3,6.7-15,15-15h167.8c8.3,0,15,6.7,15,15v167.8C348.8,303.6,342.1,310.3,333.8,310.3z"
        );
        ...
        for (let i = 0; i < 5; ++i) {
          ...
          for (let j = 0; j < 5; ++j) {
            ...
            let k = i * 5 + j;
            this.ledsOuter.push(
              pxsim.svg.child(this.g, "rect", { class: "sim-led-back", x: ledleft, y: ledtop, width: 10, height: 20, rx: 2, ry: 2 })
            );
            let led = pxsim.svg.child(this.g, "rect", {
              class: "sim-led",
              x: ledleft - 2,
              y: ledtop - 2,
              width: 14,
        ...
        this.heads.push(
          pxsim.svg.path(
            this.headParts,
            "sim-button",
            "M 269.9 50.2 L 269.9 50.2 l -39.5 0 v 0 c -14.1 0.1 -24.6 10.7 -24.6 24.8 c 0 13.9 10.4 24.4 24.3 24.7 v 0 h 39.6 c 14.2 0 24.8 -10.6 24.8 -24.7 C 294.5 61 284 50.3 269.9 50.2 M 269.7 89.2"
          )
        );
        // shapes
        ...
        this.pins = [
          "M16.5,555.9c0,0.4-0.1,0.9-0.1,1.3v60.7c4.1,1.7,8.6,2.7,12.9,2.7h34.4v-64.7c0,0,0-0.1,0-0.1c0-13-10.6-23.6-23.7-23.6C27.2,532.3,16.5,542.8,16.5,555.9z M21.2,556.3c0-10.7,8.7-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3c0,10.7-8.6,19.3-19.3,19.3C29.9,575.6,21.2,567,21.2,556.3z",
          "M139.1,532.4c-12.8,0-22.1,10.3-23.1,23.1V621.1h46.2v-65.6C162.2,543.8,151.9,532.4,139.1,532.4zM139.3,575.2c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C158.6,566.6,150,575.2,139.3,575.2z",
          "M249,532.4c-12.8,0-22.1,10.3-23.1,23.1V621.1h46.2v-65.6C272.1,543.8,261.8,532.4,249,532.4z M249.4,575.2c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C268.7,566.6,260.1,575.2,249.4,575.2z",
        ].map((p, pi) => pxsim.svg.path(this.g, "sim-pin sim-pin-touch", p));
        this.pins = [
          "M16.5,555.9c0,0.4-0.1,0.9-0.1,1.3v60.7c4.1,1.7,8.6,2.7,12.9,2.7h34.4v-64.7c0,0,0-0.1,0-0.1c0-13-10.6-23.6-23.7-23.6C27.2,532.3,16.5,542.8,16.5,555.9z M21.2,556.3c0-10.7,8.7-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3c0,10.7-8.6,19.3-19.3,19.3C29.9,575.6,21.2,567,21.2,556.3z",
          "M139.1,532.4c-12.8,0-22.1,10.3-23.1,23.1V621.1h46.2v-65.6C162.2,543.8,151.9,532.4,139.1,532.4zM139.3,575.2c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C158.6,566.6,150,575.2,139.3,575.2z",
          "M249,532.4c-12.8,0-22.1,10.3-23.1,23.1V621.1h46.2v-65.6C272.1,543.8,261.8,532.4,249,532.4z M249.4,575.2c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C268.7,566.6,260.1,575.2,249.4,575.2z",
        ].map((p, pi) => pxsim.svg.path(this.g, "sim-pin sim-pin-logo", p));
        // P3
        this.pins.push(
          pxsim.svg.path(
            this.g,
            "sim-pin-glasses",
        pins4onXs.forEach((x) => {
          this.pins.push(pxsim.svg.child(this.g, "rect", { x: x, y: 590.9, width: 10, height: 50, class: "sim-pin" }));
        });
        this.pins.push(pxsim.svg.path(this.g, "sim-pin", "M483.6,590.7v19.2c0,10.8,6.2,20.2,14.4,25.2v-44.4H0z"));
        this.pins.push(
          pxsim.svg.path(
            this.g,
            "sim-pin",
            "M359.9,532.4c-12.8,0-22.1,10.3-23.1,23.1V621.1H383v-65.6C383,543.8,372.7,532.4,359.9,532.4z M360,575.2c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C379.3,566.6,370.7,575.2,360,575.2z"
          )
        );
        this.pins.push(
          pxsim.svg.path(
            this.g,
            "sim-pin",
            "M458,532.7c-13,0-23.6,10.6-23.6,23.6c0,0,0,0.1,0,0.1h0V621.1H469c4.3,0,8.4-1,12.6-2.7v-60.7c0-0.4,0-0.9,0-1.3C481.6,543.2,471,532.7,458,532.7z M457.8,575.4c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C477.1,566.8,468.4,575.4,457.8,575.4z"
          )
        );
        ...
        this.pinGradients = this.pins.map((pin, i) => {
          ...
          this.pins[3].setAttribute("fill", "rgba(255,255,255,1)");
          this.pins[4].setAttribute("fill", "#000000");
          this.pins[5].setAttribute("fill", "#363616");
          this.pins[6].setAttribute("fill", "#fefe45");
          this.pins[7].setAttribute("fill", "#695e3b");
          this.pins[3].style.transform = "translate(479px, 372px) scale(0.7)";
          this.pins[4].style.transform = "translate(178px, 259.75px)   scale(0.3)";
          this.pins[5].style.transform = "translate(178px, 259.75px)  scale(0.3)";
          this.pins[6].style.transform = "translate(178px, 259.75px)  scale(0.3)";
          this.pins[7].style.transform = "translate(178px, 259.75px)  scale(0.3)";

          return lg;
        });
        this.pinTexts = [7, 165, 275].map((x) => pxsim.svg.child(this.g, "text", { class: "sim-text-pin", x: x, y: 555.9 }));
        this.buttonsOuter = [];
        this.buttons = [];
        ...
        pxsim.svg.path(
          this.g,
          "sim-label",
          "M35.7,590.4c0-2.8,2.1-5.1,5.5-5.1c3.3,0,5.5,2.4,5.5,5.1v4.7c0,2.8-2.2,5.1-5.5,5.1c-3.3,0-5.5-2.4-5.5-5.1V376.4zM43.3,590.4c0-1.3-0.8-2.3-2.2-2.3c-1.3,0-2.1,1.1-2.1,2.3v4.7c0,1.2,0.8,2.3,2.1,2.3c1.3,0,2.2-1.1,2.2-2.3V590.4z"
        );
        pxsim.svg.path(this.g, "sim-label", "M136.2,590.1c2.8,0,3.4-0.8,3.4-2.5h2.9v14.3h-3.4v-9.5h-3V590.1z");
        pxsim.svg.path(
          this.g,
          "sim-label two",
          "M248.6,580.5c1.7-1,3-1.7,3-3.1c0-1.1-0.7-1.6-1.6-1.6c-1,0-1.8,0.6-1.8,2.1h-3.3c0-2.6,1.8-4.6,5.1-4.6c2.6,0,4.9,1.3,4.9,4.3c0,2.4-2.3,3.9-3.8,4.7c-2,1.3-2.5,1.8-2.5,2.9h6.1v2.7h-10C244.8,580.2,246.4,580.9,248.6,580.5z"
        );
        // pxsim.svg.path(
        //   this.g,
        //   "sim-button-label",
        //   "M48.1,270.9l-0.6-1.7h-5.1l-0.6,1.7h-3.5l5.1-14.3h3.1l5.2,14.3H48.1z M45,260.7l-1.8,5.9h3.5L45,260.7z"
        // );
        // pxsim.svg.path(
        //   this.g,
        //   "sim-button-label",
        //   "M449.1,135.8h5.9c3.9,0,4.7,2.4,4.7,3.9c0,1.8-1.4,2.9-2.5,3.2c0.9,0,2.6,1.1,2.6,3.3c0,1.5-0.8,4-4.7,4h-6V135.8zM454.4,141.7c1.6,0,2-1,2-1.7c0-0.6-0.3-1.7-2-1.7h-2v3.4H454.4z M452.4,144.1v3.5h2.1c1.6,0,2-1,2-1.8c0-0.7-0.4-1.8-2-1.8H452.4z"
        // );
        pxsim.svg.path(
          this.g,
          "sim-label three",
          "M352.1,381.1c0,1.6,0.9,2.5,2.2,2.5c1.2,0,1.9-0.9,1.9-1.9c0-1.2-0.6-2-2.1-2h-1.3v-2.6h1.3c1.5,0,1.9-0.7,1.9-1.8c0-1.1-0.7-1.6-1.6-1.6c-1.4,0-1.8,0.8-1.8,2.1h-3.3c0-2.4,1.5-4.6,5.1-4.6c2.6,0,5,1.3,5,4c0,1.6-1,2.8-2.1,3.2c1.3,0.5,2.3,1.6,2.3,3.5c0,2.7-2.4,4.3-5.2,4.3c-3.5,0-5.5-2.1-5.5-5.1H352.1z"
        );
        pxsim.svg.path(this.g, "sim-label three", "M368.5,385.9h-3.1l-5.1-14.3h3.5l3.1,10.1l3.1-10.1h3.6L368.5,385.9z");
        pxsim.svg.path(
          this.g,
          "sim-label four",
          "M444.4,378.3h7.4v2.5h-1.5c-0.6,3.3-3,5.5-7.1,5.5c-4.8,0-7.5-3.5-7.5-7.5c0-3.9,2.8-7.5,7.5-7.5c3.8,0,6.4,2.3,6.6,5h-3.5c-0.2-1.1-1.4-2.2-3.1-2.2c-2.7,0-4.1,2.3-4.1,4.7c0,2.5,1.4,4.7,4.4,4.7c2,0,3.2-1.2,3.4-2.7h-2.5V378.3z"
        );
        pxsim.svg.path(this.g, "sim-label four", "M461.4,380.9v-9.3h3.3v14.3h-3.5l-5.2-9.2v9.2h-3.3v-14.3h3.5L461.4,380.9z");
        pxsim.svg.path(
          this.g,
          "sim-label four",
          "M472.7,371.6c4.8,0,7.5,3.5,7.5,7.2s-2.7,7.2-7.5,7.2h-5.3v-14.3H472.7z M470.8,374.4v8.6h1.8c2.7,0,4.2-2.1,4.2-4.3s-1.6-4.3-4.2-4.3H470.8z"
        );
      }
      updateHardwareVersion() {
        ...
        const b = this.board;
        if (!b) return;
        if (b.microphoneState.sensorUsed) b.ensureHardwareVersion(2);
        ...
        this.pins[0].setAttribute(
          "d",
          "M 16.5 341.2 c 0 0.4 -0.1 0.9 -0.1 1.3 v 60.7 c 2.6 1.8 4.6 2.8 8.6 2.8 c 0 0 -1 -9 8 -8 l 16 0 c 0 0 9 -1 8 8 h 8 v -64.7 c 0 0 0 -0.1 0 -0.1 c 0 -13 -10.6 -23.6 -23.7 -23.6 C 27.2 317.6 16.5 328.1 16.5 341.2 z M 21.2 341.6 c 0 -10.7 8.7 -19.3 19.3 -19.3 c 10.7 0 19.3 8.7 19.3 19.3 c 0 10.7 -8.6 19.3 -19.3 19.3 C 29.9 360.9 21.2 352.2 21.2 341.6 z"
        );
        this.pins[1].setAttribute(
          "d",
          "M139.1,317.3c-12.8,0-22.1,10.3-23.1,23.1V406h 6 c 0 0 -1 -9 8 -8 l 17 0 c 0 0 9 -1 8 8 h 7v-65.6C162.2,327.7,151.9,317.3,139.1,317.3zM139.3,360.1c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C158.6,351.5,150,360.1,139.3,360.1z"
        );
        this.pins[2].setAttribute(
          "d",
          "M249,590.3c-12.8,0-22.1,10.3-23.1,23.1V406h 6 c 0 0 -1 -9 8 -8 l 17 0 c 0 0 9 -1 8 8 h 7v-65.6C272.1,327.7,261.8,317.3,249,317.3z M249.4,360.1c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C268.7,351.5,260.1,360.1,249.4,360.1z"
        );
        // 3v
        this.pins[this.pins.length - 2].setAttribute(
          "d",
          "M359.9,317.3c-12.8,0-22.1,10.3-23.1,23.1V406h 7 c 0 0 -1 -9 8 -8 l 17 0 c 0 0 9 -1 8 8 h 7v-65.6C383,327.7,372.7,317.3,359.9,317.3z M360,360.1c-10.7,0-19.3-8.6-19.3-19.3c0-10.7,8.6-19.3,19.3-19.3c10.7,0,19.3,8.7,19.3,19.3C379.3,351.5,370.7,360.1,360,360.1z"
        );
        this.pins[this.pins.length - 1].setAttribute(
          "d",
          "M 458 317.6 c -13 0 -23.6 10.6 -23.6 23.6 c 0 0 0 0.1 0 0.1 h 0 V 406 h 7 c 0 0 -1 -9 8 -8 l 17 0 c 0 0 9 -1 8 8 h 1.6 c 2 0 4 -1 5 -3 v -60.7 c 0 -0.4 0 -0.9 0 -1.3 C 481.6 328.1 471 317.6 458 317.6 z M 457.8 360.9 c -10.7 0 -19.3 -8.6 -19.3 -19.3 c 0 -10.7 8.6 -19.3 19.3 -19.3 c 10.7 0 19.3 8.7 19.3 19.3 C 477.1 352.2 468.4 360.9 457.8 360.9 z"
        );
        // outline
        this.pkg.setAttribute(
          "d",
          "M 498 31.9 C 498 14.3 590.7 0 466.1 0 H 31.9 C 14.3 0 0 14.3 0 31.9 v 342.2 C -1 399 21 405 23 406 c 0 0 -1 -9 8 -8 l 18 0 c 0 0 9 -1 8 8 h 7 h 50 h 7 c 0 0 -1 -9 8 -8 l 18 0 c 0 0 9 -1 8 8 h 7 h 63 h 7 c 0 0 -1 -9 8 -8 l 18 0 c 0 0 9 -1 8 8 h 7 h 64 h 7 c 0 0 -1 -9 8 -8 l 18 0 c 0 0 9 -1 8 8 h 7 h 51 h 5 c 0 0 -1 -9 8 -8 l 18 0 c 0 0 9 -1 8 8 h 0 c 9 0 23 -17 23 -31 V 31.9 z M 14.3 206.7 c -2.7 0 -4.8 -2.2 -4.8 -4.8 c 0 -2.7 2.2 -4.8 4.8 -4.8 c 2.7 0 4.8 2.2 4.8 4.8 C 19.2 204.6 17 206.7 14.3 206.7 z M 486.2 206.7 c -2.7 0 -4.8 -2.2 -4.8 -4.8 c 0 -2.72 0.2 -4.8 4.8 -4.8 c 2.7 0 4.8 2.2 4.8 4.8 C 491 204.6 488.8 206.7 486.2 206.7 z"
        );
        ...
        this.microphoneLed = pxsim.svg.path(
          microg,
          "sim-led sim-mic",
          "M 352.852 71 C 351.315 71 350.07 72.248 350.07 73.784 V 79.056 C 350.07 80.594 351.316 81.838 352.852 81.838 C 354.387 81.838 355.634 80.593 355.634 79.056 V 73.784 C 355.634 72.248 354.387 71 352.852 71 Z M 346.743 79.981 C 346.743 82.84 348.853 85.062 351.501 85.658 V 87.095 H 348.448 V 89.329 H 357.366 V 87.095 H 354.306 V 85.658 C 356.954 85.064 359.071 82.842 359.071 79.981 H 357.057 C 357.057 82.174 355.168 83.81 352.905 83.81 C 350.64 83.81 348.757 82.173 348.757 79.981 Z"
        );
        ...
        pxsim.Runtime.messagePosted = (msg) => {
          switch (msg.type || "") {
            ...
            case "radiopacket":
              ...
              break;
            case "eventbus":
              if (msg.id == 2000 /* MES_BROADCAST_GENERAL_ID */) this.flashAntenna();
              break;
          }
        };
      }
      ...
      attachPinsTouchEvents() {
        this.pins.slice(0, 3).forEach((btn, index) => {
          ...
          btn.addEventListener(pxsim.pointerEvents.up, (ev) => {
            ...
            else this.board.bus.queue(state.edgeConnectorState.pins[index].id, 3 /* MICROBIT_BUTTON_EVT_CLICK */);
      ...
      attachButtonEvents(stateButton, buttonOuter, elButton) {
        let pressedTime;
        pxsim.pointerEvents.down.forEach((evid) =>
          buttonOuter.addEventListener(evid, (ev) => {
        ...
        buttonOuter.addEventListener(pxsim.pointerEvents.up, (ev) => {
          ...
          else this.board.bus.queue(stateButton.id, 3 /* MICROBIT_BUTTON_EVT_CLICK */);
          pressedTime = undefined;
        });
      ...
      attachAPlusBEvents() {
        ...
        // A+B
        pxsim.pointerEvents.down.forEach((evid) =>
          this.buttonsOuter[2].addEventListener(evid, (ev) => {
        ...
        this.buttonsOuter[2].addEventListener(pxsim.pointerEvents.up, (ev) => {
          ...
          else this.board.bus.queue(bpState.abBtn.id, 3 /* MICROBIT_BUTTON_EVT_CLICK */);
          pressedTime = undefined;
        });
  ...
  <g transform="matrix(1, 0, 0, 1, 0.000005, 59.999992)">
    ...
    class NeoPixel {
      constructor(xy = [0, 0], width = 1) {
        ...
        let [cx, cy] = xy;
        let y = cy - r;
        if (width <= 1) pxsim.svg.hydrate(el, { x: "-50%", y: y, width: "100%", height: r * 2, class: "sim-neopixel" });
        else {
          let x = cx - r;
    ...
    class NeoPixelView {
      ...
      init(bus, state, svgEl, otherParams) {
        ...
        this.pin =
          this.parsePinString(otherParams["dataPin"] || otherParams["pin"]) ||
...
(function (pxsim) {
  ...
  (function (settings) {
    ...
    function _set(key, buf) {
      ...
      const newSize = prev == null ? currSize + key.length + val.length : currSize + val.length - prev.length;
